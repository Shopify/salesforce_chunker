...
class BulkApiTest < Minitest::Test
  ...
  def setup
    ...
    @connection = SalesforceChunker::Connection::BulkApi.new({})
  ...
  def test_error_raised_when_failure_response
    ...
    assert_raises SalesforceChunker::ConnectionError do
      SalesforceChunker::Connection::BulkApi.new({})
    end
  end
  ...
  def test_initialize_uses_correct_domain_and_version
    ...
    SalesforceChunker::Connection::BulkApi.new(domain: "test", salesforce_version: "37.0")
  end
  ...
  def test_get_instance_extracts_instance
    ...
    extracted_instances = urls.map { |url| SalesforceChunker::Connection::BulkApi.get_instance(url) }
